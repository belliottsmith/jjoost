...
import org.jjoost.collections.base.HashTableCounting ;
import org.jjoost.collections.base.HashTableType ;
...
public class MapMaker {
	...
	public static class HashMapMaker<K, V> extends AbstractMapMaker<K, V> {
		...
		private HashTableType type = HashTableType.serial() ;
		private int initialCapacity = 16 ;
		private float loadFactor = 0.75f ;
		private HashTableCounting counting ;
		...
		private HashMapMaker(Hasher<? super K> keyHasher, Rehasher rehasher,
				...
				Equality<? super V> valEquality, HashTableType type,
				int initialCapacity, float loadFactor,
				HashTableCounting counting, Function<K, V> factoryFunction,
				Factory<V> factory) {
			super();
		...
		public HashMapMaker<K, V> type(HashTableType type) { this.type = type ; return this ; }
		...
		public HashMapMaker<K, V> counting(HashTableCounting counting) { this.counting = counting ; return this ; }
		...
		public ScalarMap<K, V> newScalarMap() {
			...
			case SYNCHRONIZED:
				ScalarMap<K, V> r = new SerialScalarHashMap<K, V>(
						...
						keyEquality,
						valEquality) ;
				if (type.type() == HashTableType.Type.SYNCHRONIZED)
