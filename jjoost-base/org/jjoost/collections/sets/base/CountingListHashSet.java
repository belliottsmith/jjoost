...
public class CountingListHashSet<V, N extends CountingListHashSet.INode<V, N>> implements ListSet<V> {
	...
	protected CountingListHashSet(Counter counter, Hasher<? super V> valHasher, Rehasher rehasher, HashNodeFactory<V, N> nodeFactory, ValueEquality<V, N> equality, HashStore<N> table) {
		this.table = table ;
