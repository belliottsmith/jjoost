...
public class SetMaker {
	...
	public static class HashSetMaker<V> extends AbstractSetMaker<V> {
		...
		private HashSetMaker(Hasher<? super V> hasher, Rehasher rehasher,
				Equality<? super V> eq, HashTableType type,
				int initialCapacity, float loadFactor,
				HashTableCounting counting) {
			super();
			this.hasher = hasher ;
		...
		public HashSetMaker<V> type(HashTableType type) { this.type = type ; return this ; }
		...
		public HashSetMaker<V> counting(HashTableCounting counting) { this.counting = counting ; return this ; }
