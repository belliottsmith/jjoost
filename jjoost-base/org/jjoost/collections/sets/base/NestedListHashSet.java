...
public class NestedListHashSet<V, N extends NestedListHashSet.INode<V, N>> implements ListSet<V> {
	...
	protected NestedListHashSet(Counter counter, Hasher<? super V> valHasher, Rehasher rehasher, ValueEquality<V, N> equality, HashNodeFactory<V, N> nodeFactory, HashTable<N> table) {
		this.table = table ;
