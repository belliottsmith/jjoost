...
public class SerialLinkedScalarHashMap<K, V> extends ScalarHashMap<K, V, SerialLinkedScalarHashMap.Node<K, V>>{
	...
	public static void main(String[] args) {
		Map<Integer, Integer> map = new SerialLinkedScalarHashMap<Integer, Integer>() ;
		for (int i = 0 ; i != 100 ; i++) {
			map.put(i, i) ;
			map.put(i, i + 1) ;
			map.put(i, i) ;
	...
	public static final class EntryEquality<K, V> extends ScalarHashMap.NodeEquality<K, V, Node<K, V>> {
